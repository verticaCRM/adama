...
if(count((array)$results) > 0 && $results->status != "404"){
	...
	if(!in_array($searchlisting->id,$listingids)){
		...
		$html .= "<div style='display:block' class='searchresult'><p><a style='font-size:1.3em' href=\"/listing/". sanitize_title($searchlisting->c_name_generic_c) ."\" class=\"listing_link theme-color2-dk\" data-id=\"". $searchlisting->id ."\">".$searchlisting->c_name_generic_c."</a></p>";
...
$html .= "<p class='theme-color1-dk' style='font-size:1.3em;'>".__("",'bbcrm').$searchlisting->c_currency_id.number_format($searchlisting->c_listing_askingprice_c).'</p>';
...
if(!is_user_logged_in()){	
	$html .= "<div style='display:inline-block;width:20%;vertical-align:top;'><p><a href='/registration/'><span style='font-size:1.0em;color:#ffffff; padding:4px; 3px 10px;width: 120px;text-align: center;' class='theme-background2-dk' >".__("Contact Seller",'bbcrm').$searchlisting->c_listing_businesscat_c."</span></a></p>";

	$html .= '<p><a href="/listing/'.sanitize_title($searchlisting->c_name_generic_c).'" class="listing_link" data-id="'.$searchlisting->id.'">'."<span class='theme-background2-dk' style='font-size:1.0em;color:#ffffff;padding: 3px 10px;width: 120px;text-align: center; '>".__("More Info",'bbcrm').$searchlisting->c_listing_businesscat_c."</span></a></p></div>";
}	
