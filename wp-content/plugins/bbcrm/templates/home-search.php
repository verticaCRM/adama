<h3 class="theme-color1-dk" style="margin:0;margin-top:10px;width:40%"><span class="fa fa-search theme-color1-dk" style="padding:7px 8px;margin-right:5px;"></span><?php _e($a['title'],'bbcrm');?></h3>
<div class="theme-background1-lt" style="padding:18px; border:3px solid #ead6a8;margin-bottom: 18px;" id="pagewidget" class="searchbox theme-color-border">

<form method="get" action="<?php get_permalink($bbcrm_option["bbcrm_loginbar_searchresults"]);?>" >
<div style="display:inline-block;vertical-align:top;margin-right:12px;"><label class="theme-color2-lt" for="c_listing_region_c"><?php _e("By State/Territory",'bbcrm')?></label><br><select style="background-color:#ffffff;" name="c_listing_town_c" id="c_listing_town_c"><option value=''>Please select</option>
<?php
global $bbcrm_option;
	...
	function(response){
		console.log(response)
			jQuery.each(response, function(key, value) {
				...
				jQuery("#c_listing_city_c").empty().append(jQuery("<option></option>").attr("value", "").text("Please select a suburb"));
