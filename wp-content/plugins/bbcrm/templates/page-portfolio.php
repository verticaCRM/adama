...
<form method="post" style="display:inline"><input type=hidden name="uid" value="<?php echo $crmid;?>"><input type=hidden name="pid" value="<?php echo $portfolioitem->id;?>"><input type=hidden name="action" value="hide"><input type=submit value="Hide from Data Room" class="portfoliobutton"></form> 
